...
const team = {
  ...
  colaboradores: [
    ...
    { name: "Douglas Fonseca", specialization: "Licenciatura em Física", education: "Desenvolvimento e aplicação de simulações e jogos digitais para a compreensão de conceitos de mecânica no ensino de Física.", image: import.meta.env.BASE_URL + "ronan.jpeg", email: "bia@lafi.com", linkedin: "#", bio: "Este projeto propõe o desenvolvimento e a aplicação de simulações interativas e jogos digitais para facilitar a compreensão de conceitos abstratos de mecânica, como o movimento retilíneo e as Leis de Newton. Utilizando técnicas de game design e programação computacional, a pesquisa visa transformar equações teóricas em experimentos virtuais concretos e manipuláveis. O objetivo é estruturar sequências didáticas para o Ensino Médio e a graduação, validando, por meio de uma abordagem quali-quantitativa, como a ludicidade e a interatividade auxiliam na superação da aprendizagem mecânica e promovem o protagonismo do aluno na construção do conhecimento científico." },
  ],
};
