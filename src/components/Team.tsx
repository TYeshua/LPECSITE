...
const team = {
  ...
  pesquisadores: [
    ...
    { name: "Maria G. D. Silva", role:"", specialization:"Doutora em Física da Matéria Condensada", education:" Magnetismo e Materiais Magnéticos (Spintrônica)", image: import.meta.env.BASE_URL + "maria.png", email:"", linkedin:"", bio:"Possui graduação em Licenciatura em Física pela Universidade do Estado do Rio Grande do Norte (2008) , mestrado (2010) e doutorado (2014) em Física da Matéria Condensada pela Universidade Federal do Rio Grande do Norte. Atualmente é Professora Classe III, nível IV da Universidade do Estado do Rio Grande do Norte, onde desenvolve pesquisas em Magnetismo e Materiais Magnéticos (Spintrônica)." }
  ],
  colaboradores: [
